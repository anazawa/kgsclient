(function () {
    ...
    var kgsPoller = function (args) {
        ...
        var that = {},
            ...
            RESPONSE_TYPES = kgsPoller.RESPONSE_TYPES;

        var statusLine = function (xhr) {
            return xhr.status ? xhr.status+" "+xhr.statusText : "";
        };
        ...
        var poll = function () {
            ...
            xhr.onerror = function () {
                that.logger.error("GET "+url+" failed: "+statusLine(xhr));
        ...
        that.request = function (message, onSuccess, onError) {
            ...
            xhr.onerror = function () {
                that.logger.error("POST "+url+" failed: "+statusLine(xhr));
